...
int main(void)
{
    // Avoid wacky window streching, which will make for an ugly triangle. (Ignore DPI adjustments)
    ...
    HWND hwnd;
    {
        ...
        RECT initialRect = { 0, 0, 600, 450 }; // Default Window size
        ...
        hwnd = CreateWindowExW(0, winClass.lpszClassName, L"Triangle Test",
    ...
    float vertices[] = 
    { //   x,     y,    z,    r,   g,   b,   a
        0.0f,  1.f,  0.f,  0.f, 1.f, 0.f, 1.f,
        0.f, -1.0f,  0.f,  1.f, 0.f, 0.f, 1.f,
...
#if 0
    // Vertices for the Rombus
    float vertices[] =
    { //   x,     y,    z,    r,   g,   b,   a
        0.f,  1.f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
        1.f, 0.f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
       0.f, -1.f,  0.f,  1.f, 0.7f, 0.7f, 1.f,

       -0.5f,  1.f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
        -0.5f, -1.0f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
       -1.0f, 0.f,  0.f, 1.f, 0.7f, 0.7f, 1.f,
    ...
    float vertices[] =
    { //   x,     y,    z,    r,   g,   b,   a
        -1.f, 0.5f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
        -0.5f, 1.f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
        -0.5f, 0.5f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
 

        -0.5f, 1.f,  0.f,  1.f, 0.6f, 0.7f, 1.f,
         0.5f, 0.5f,  0.f,  1.f, 0.6f, 0.7f, 1.f,
        -0.5f, 0.5f,  0.f,  1.f, 0.6f, 0.7f, 1.f,



        -0.5f, 1.f,  0.f,  1.f, 0.4f, 0.7f, 1.f,
         0.5f, 1.f,  0.f,  1.f, 0.4f, 0.7f, 1.f,
         0.5f, 0.5f,  0.f,  1.f, 0.4f, 0.7f, 1.f,

          
         0.5f, 1.f,  0.f,  1.f, 0.7f, 0.5f, 1.f,
         1.f, 0.5f,  0.f,  1.f, 0.7f, 0.5f, 1.f,
         0.5f, 0.5f,  0.f,  1.f, 0.7f, 0.5f, 1.f,

         0.5f, 1.f,  0.f,  1.f, 0.7f, 0.4f, 1.f,
         1.f, 0.5f,  0.f,  1.f, 0.7f, 0.4f, 1.f,
         0.5f, 0.5f,  0.f,  1.f, 0.7f, 0.4f, 1.f,





         -1.0f, 0.5f,  0.f,  1.f, 0.3f, 0.7f, 1.f,
         1.0f, 0.5f,  0.f,  1.f, 0.3f, 0.7f, 1.f,
         -1.0f, -0.5f,  0.f,  1.f, 0.3f, 0.7f, 1.f,

         -1.0f, -0.5f,  0.f,  1.f, 0.7f, 0.3f, 1.f,
         1.0f, 0.5f,  0.f,  1.f, 0.7f, 0.3f, 1.f,
         1.0f, -0.5f,  0.f,  1.f, 0.7f, 0.3f, 1.f,
         ...
         -1.0f, -0.5f,  0.f,  1.f, 0.4f, 0.7f, 1.f,
         -0.5f, -0.5f,  0.f,  1.f, 0.4f, 0.7f, 1.f,
         -0.5f, -1.0f,  0.f,  1.f, 0.4f, 0.7f, 1.f,


         -0.5f, -0.5f,  0.f,  1.f, 0.8f, 0.7f, 1.f,
         0.5f, -0.5f,  0.f,  1.f, 0.8f, 0.7f, 1.f,
        -0.5f, -1.0f,  0.f,  1.f, 0.8f, 0.7f, 1.f,

           -0.5f, -1.0f,  0.f,  1.f, 0.3f, 0.7f, 1.f,
          0.5f, -0.5f,  0.f,  1.f, 0.3f, 0.7f, 1.f,
         0.5f, -1.0f,  0.f,  1.f, 0.3f, 0.7f, 1.f,

            0.5f, -0.5f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
          1.0f, -0.5f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
         0.5f, -1.0f,  0.f,  1.f, 0.7f, 0.6f, 1.f,
    ...
    float vertices[] =
    { //   x,     y,    z,    r,   g,   b,   a
       -0.5f,  0.5f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
        0.5f,  0.5f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
        0.5f, -0.5f,  0.f,  1.f, 0.7f, 0.7f, 1.f,
    ...
    { //   x,     y,    z,    r,   g,   b,   a
       ...
       -0.5f, -0.5f,  0.f,  0.f, 0.f, 1.f, 1.f,
        1.0f,  0.5f,  0.f,  0.f, 1.f, 0.f, 1.f,
        0.9f, -0.5f,  0.f,  1.f, 0.f, 0.f, 1.f,
        0.5f, -0.5f,  0.f,  0.f, 0.f, 1.f, 1.f
